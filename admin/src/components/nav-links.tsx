...
import { 
    LayoutDashboard, TrendingUp, CalendarCheck, ShieldCheck, Wallet, UserCheck, 
    Building, BookOpen, Layers, UserPlus, Settings, ChevronDown, BarChart2
} from 'lucide-react'
                    ...
                    return (
                        <Popover key={item.label}>
                            <PopoverTrigger asChild>
                                <button className={`flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium transition-all outline-none ${isActive
