...
import { TrendingUp, CalendarCheck, ShieldCheck, ArrowRight } from 'lucide-react'
...
const quickActions = [
  ...
  { label: 'Attendance', description: 'Track daily attendance', href: '/analytics/attendance', icon: CalendarCheck, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-500/10' },
  { label: 'Approvals', description: 'Review access requests', href: '/approvals', icon: ShieldCheck, color: 'text-amber-600 dark:text-amber-400', bg: 'bg-amber-500/10' },
]
